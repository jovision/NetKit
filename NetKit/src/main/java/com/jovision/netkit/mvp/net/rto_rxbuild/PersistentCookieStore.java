...
//    }
    ...
    protected String encodeCookie(SerializableHttpCookie cookie) {
        ...
        try {
            ...
            LogUtil.v(LOG_TAG, "IOException in encodeCookie"+e);
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtil.v(LOG_TAG, "IOException in decodeCookie"+e);
        } catch (ClassNotFoundException e) {
            LogUtil.v(LOG_TAG, "ClassNotFoundException in decodeCookie"+e);
        }
